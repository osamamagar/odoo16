...
class HrContract(models.Model):
    ...
    overtime_rate = fields.Float(string='Overtime Rate', required=True, default=0.0)
    attendance_rate = fields.Float(string='Attendance Rate', required=True, default=0.0)
